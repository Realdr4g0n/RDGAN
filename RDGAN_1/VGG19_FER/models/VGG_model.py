...
class FERANet2(nn.Module):
    def __init__(self):
        super(FERANet2, self).__init__()

        self.conv1_1 = nn.Conv2d(1, 64,(3, 3),(1, 1),(1, 1))
        self.relu1_1 = nn.ReLU(inplace=True)
        self.conv1_2 = nn.Conv2d(64, 64,(3, 3),(1, 1),(1, 1))
        self.relu1_2 = nn.ReLU(inplace=True)
        self.pool1 = nn.MaxPool2d((2, 2),(2, 2),(0, 0), ceil_mode=True)  # 1/2
        ...
        self.pool2 = nn.MaxPool2d((2, 2),(2, 2),(0, 0), ceil_mode=True)  # 1/4
        ...
        self.pool3 = nn.MaxPool2d((2, 2),(2, 2),(0, 0), ceil_mode=True)  # 1/8
        ...
        self.pool4 = nn.MaxPool2d((2, 2),(2, 2),(0, 0), ceil_mode=True)  # 1/16
        ...
        self.pool5 = nn.MaxPool2d((2, 2),(2, 2),(0, 0), ceil_mode=True)  # 1/32
        ...
        self.classify = nn.Linear(4096, 7)
